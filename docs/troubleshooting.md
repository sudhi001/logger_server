...
```sh
docker run -v logger-data:/data ... sudhis/logger_server:3.0.0
```
...
```sh
docker tag localhost/sudhis/logger_server:3.0.0 docker.io/sudhis/logger_server:3.0.0
docker push docker.io/sudhis/logger_server:3.0.0
```
